...
p many_vowel_words("Hello world, how are you")#).to eq("Hello are you")
p many_vowel_words("The quick brown fox jumps over the lazy dog")#).to eq("quick over")
p many_vowel_words("The Missippi river is quite the river")#).to eq("Missippi river quite river")
